 ...
 * storage.rules protects. That was considered and rejected — see the project log,
 * open decision #2.
 *
 ...
 * The project log's reasoning holds: an unreviewed automatic rules deploy is worse
