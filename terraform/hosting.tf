...
#      a single request. That fails the constraint at the top of the project log's
...
# app-layer config, exactly like firestore.rules. The project log's division holds
# without amendment.
#
