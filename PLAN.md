...
**Superseded — see the project log for the current architecture.** The project moved to GCP serverless (Firebase Hosting + Auth, Firestore, Cloud Functions 2nd gen, Cloud Storage, Maps JS API).
