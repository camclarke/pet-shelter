...
function init() {
  ...
  // The language of the Google sign-in window and of Firebase's own messages.
  // Without it the Google account chooser opens in the browser's language.
  authInstance.languageCode = SHELTER.locale.split('-')[0] ?? 'es';
